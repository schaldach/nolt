    ...
    return (
        <PreviewBox type={type} isShown={linksBox} exit={() => showLinks(false)}>
            {allLinks.map(link =>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className={links.indexOf(link)!==-1?'previewcheckedsvglink':'displaynone'} fill="none" viewBox="0 0 24 24" stroke="var(--color3)" strokeWidth={2}>
