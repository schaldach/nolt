...
function DropdownMenu({editMode, onEdit, viewMode, onView, onDelete, onFavorite, favorite}) {
    return (
        <>
        <div className={viewMode ? 'functionality menuview' : 'functionality'}>
            <div className='dropdownbutton functionbutton'>
            ...
            <div onClick={onEdit} className='functionbutton'>
            ...
            <div onClick={onView} className='functionbutton'>
            ...
            <div onClick={onFavorite} className="functionbutton">
            ...
            <div onClick={onDelete} className='deletebutton functionbutton'>
                <svg xmlns="http://www.w3.org/2000/svg" className="dropdownsvg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
