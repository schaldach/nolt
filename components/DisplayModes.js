function DisplayModes({editMode, viewMode, favorite, calendar, small, filtered}) {
    return (
        <div className="displaymodes">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={filtered?'modesvg':'displaynone'} viewBox="0 0 20 20" fill="var(--color3)">
