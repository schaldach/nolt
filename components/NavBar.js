            ...
            <div className='sections'>
                ...
                <Link href={'/'+currentNote} >
                    <div className='contentselection' onClick={() => changeCurrentPage(currentNote)}>
                        <div className={currentPage==='notas'||currentPage==='listas'||currentPage==='links'||currentPage==='fotos'?'navbar-select contentselected':'navbar-select'}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className={currentNote==='fotos'?"navbarsvg":"displaynone"} viewBox="0 0 20 20" fill="currentColor">
