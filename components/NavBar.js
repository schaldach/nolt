        ...
        <div className='navbar'>
            ...
            <div className='sections'>
                ...
                <div className='dropdowns'>
                    <button onClick={() => changeCurrentNote('notas')} className='dropdownitem'>Notas</button>
                    <button onClick={() => changeCurrentNote('listas')} className='dropdownitem'>Listas</button>
                    <button onClick={() => changeCurrentNote('links')} className='dropdownitem'>Links</button>
                </div>
                </div>
                <Link href='/project'>
                <div className='navbar-select'>
