    ...
    return (
        <div className={viewMode ? 'functionality menuview' : 'functionality'}>
            ...
            <button onClick={onFavorite} className="functionbutton">
                <svg xmlns="http://www.w3.org/2000/svg" className="dropdownsvg" fill={favorite?'var(--color3)':'none'} viewBox="0 0 24 24" stroke={favorite?'var(--color3)':'none'} strokeWidth={2}>
