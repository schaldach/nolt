    ...
    return (
        <div className="login">
            ...
            <div className="loginbox">
                ...
                <button type="button" className={recoverPassword?"loginbutton logintext":'displaynone'} onClick={alterPassword}>Enviar email
                ...
                <button type="button" className={login&&!recoverPassword?"loginbutton logintext":'displaynone'} onClick={signin}>Login
                ...
                <button type="button" className={!login&&!recoverPassword?'loginbutton logintext':"displaynone"} onClick={signup}>Cadastro
                <svg xmlns="http://www.w3.org/2000/svg" className="loginsvg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                </svg>
                </button>
